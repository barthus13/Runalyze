...
class Version20170606090000 extends AbstractMigration implements ContainerAwareInterface
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE `'.$prefix.'calendar_note` ADD CONSTRAINT FK_5BF96DBF75A974A FOREIGN KEY (accountid) REFERENCES `'.$prefix.'account` (id)');
        $this->addSql('ALTER TABLE `'.$prefix.'calendar_note_category` ADD CONSTRAINT FK_D1C190C9F75A974A FOREIGN KEY (accountid) REFERENCES `'.$prefix.'account` (id)');
